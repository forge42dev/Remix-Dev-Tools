 ...
 * pattern.
 *
 * @see Docs     https://TODO.com/menu-button
...
import { Popover, type PositionPopover } from "./popover";
import {
  DropdownProvider,
  useDropdownItem,
  useDropdownItems,
 ...
 *
 * @see Docs https://TODO.com/menu-button#menu
 */
...
/**
 * @see Docs https://TODO.com/menu-button#menu-props
 */
interface MenuProps {
  /**
   * Requires two children: a `<MenuButton>` and a `<MenuList>`.
   *
   * @see Docs https://TODO.com/menu-button#menu-children
   */
  children:
    | React.ReactNode
    | ((
 ...
 *
 * @see Docs https://TODO.com/menu-button#menubutton
 */
...
/**
 * @see Docs https://TODO.com/menu-button#menubutton-props
 */
interface MenuButtonProps {
  /**
   * Accepts any renderable content.
   *
   * @see Docs https://TODO.com/menu-button#menubutton-children
   */
...
interface MenuItemImplProps {
   ...
   *
   * @see Docs https://TODO.com/menu-button#menuitem-children
   */
  children: React.ReactNode;
  /**
   * Callback that fires when a `MenuItem` is selected.
   *
   * @see Docs https://TODO.com/menu-button#menuitem-onselect
   */
  onSelect(): void;
  index: number;
  valueText?: string;
   ...
   *
   * @see Docs https://TODO.com/menu-button#menuitem-disabled
   */
  disabled?: boolean;
}
 ...
 *
 * @see Docs https://TODO.com/menu-button#menuitem
 */
...
/**
 * @see Docs https://TODO.com/menu-button#menuitem-props
 */
type MenuItemProps = MenuItemImplProps;
 ...
 *
 * @see Docs https://TODO.com/menu-button#menuitems
 */
...
/**
 * @see Docs https://TODO.com/menu-button#menuitems-props
 */
interface MenuItemsProps {
  /**
   * Can contain only `MenuItem` or a `MenuLink`.
   *
   * @see Docs https://TODO.com/menu-button#menuitems-children
   */
  children: React.ReactNode;
}
 ...
 *
 * @see Docs https://TODO.com/menu-button#menulink
 */
const MenuLink = React.forwardRef(
  ({ as = "a", onSelect, ...props }, forwardedRef) => {
    return (
      <MenuItemImpl
        {...props}
        ref={forwardedRef}
...
/**
 * @see Docs https://TODO.com/menu-button#menulink-props
 */
type MenuLinkProps = Omit<MenuItemImplProps, "onSelect"> & {
  onSelect?(): void;
};
 ...
 * a `<Menu>`.
 *
 * @see Docs https://TODO.com/menu-button#menulist
 */
...
/**
 * @see Docs https://TODO.com/menu-button#menulist-props
 */
interface MenuListProps {
   ...
   * `true`.
   *
   * @see Docs https://TODO.com/menu-button#menulist-portal
   */
  portal?: boolean;
  /**
   * Can contain only `MenuItem` or a `MenuLink`.
   *
   * @see Docs https://TODO.com/menu-button#menulist-children
   */
  children: React.ReactNode;
}
 ...
 *
 * @see Docs https://TODO.com/menu-button#menupopover
 */
...
/**
 * @see Docs https://TODO.com/menu-button#menupopover-props
 */
interface MenuPopoverOwnProps {
  /**
   * Must contain a `MenuItems`
   *
   * @see Docs https://TODO.com/menu-button#menupopover-children
   */
  children: React.ReactNode;
  /**
   * Whether or not the popover should be rendered inside a portal. Defaults to
   * `true`.
   *
   * @see Docs https://TODO.com/menu-button#menupopover-portal
   */
  portal?: boolean;
  /**
   ...
   *
   * @see Docs https://TODO.com/menu-button#menupopover-position
   */
 ...
 *
 * @see Docs https://TODO.com/menu-button#usemenubuttoncontext
 */
