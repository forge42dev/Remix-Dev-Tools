...
const Sparkles = () => {
  return (
    <div className="flex h-screen w-full flex-col items-center justify-center overflow-hidden rounded-md bg-slate-950 pt-40">
      <h1 className="relative z-20 text-center text-3xl font-bold text-white md:text-5xl lg:text-7xl">
        Level up your development
      </h1>
      <div className="relative h-40 w-[80rem]">
        {/* Gradients */}
