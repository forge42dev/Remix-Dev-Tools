...
export default function LoginRoute() {
  return (
    <>
      ...
      <SocialButton provider={AuthStrategies.GITHUB} label="Login with github" />
      <SocialButton provider={AuthStrategies.GOOGLE} label="Login with google" />
      <SocialButton provider={AuthStrategies.FACEBOOK} label="Login with facebook" />
      <SocialButton provider={AuthStrategies.DISCORD} label="Login with discord" />
      <SocialButton provider={AuthStrategies.MICROSOFT} label="Login with microsoft" />
      <SocialButton provider={AuthStrategies.AUTH0} label="Login with auth0" />
      <SocialButton provider={AuthStrategies.TWITTER} label="Login with twitter" />
    </>
  );
}